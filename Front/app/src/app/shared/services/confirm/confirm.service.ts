        ...
        <div class="ng-confirm-geral" [ngClass]="{'ng-confirm-in': modalShow, 'ng-confirm-out': !modalShow}" id="ng-confirm-1">
            <div class="ng-confirm-area">
                <div class="ng-confirm-container">
                    ...
                    <div>
                        <button class="btn btn-primary" (click)="okBtn()" id="ng-confirm-ok" [innerHtml]="okBtnLabel" autofocus></button>
                        <button class="btn btn-none" (click)="cancelarBtn()"id="ng-confirm-cancel" [innerHtml]="cancelarBtnLabel"></button>
                    </div>
                </div>
            </div>
        </div>
...
export class ConfirmComponent implements OnInit {
    ...
    private msgConfirmacao: String;
    private okBtnLabel: String;
    private cancelarBtnLabel: String;
