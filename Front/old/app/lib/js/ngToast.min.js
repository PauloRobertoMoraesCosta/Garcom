          ...
          return {
            ...
            update: function(id, updatedMsg) {
              ...
              if (id) {
                ...
                if (updatedMsg.className) {
                  message.className = updatedMsg.className;
                }
                if (updatedMsg.timeout) {
                  message.timeout = updatedMsg.timeout;
                }
                if (updatedMsg.dismissOnTimeout) {
                  message.dismissOnTimeout = updatedMsg.dismissOnTimeout;
                  if (messages[i].dismissOnTimeout === true) {
                    setTimeout(function() {
                      var id = message.id;
