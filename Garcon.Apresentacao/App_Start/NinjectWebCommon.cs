[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Garcom.Apresentacao.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Garcom.WebApi.App_Start.NinjectWebCommon), "Stop")]

namespace Garcom.Apresentacao.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                //System.Web.Http.GlobalConfiguration.Configuration.DependencyResolver = new Ninject.WebApi.DependencyResolver.NinjectDependencyResolver(kernel);// colocado depois
